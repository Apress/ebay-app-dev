...
namespace com.lothlorien.ebaysdkbook
{
	...
	public class ConfigDialog : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.ok.Location = new System.Drawing.Point(8, 216);
			this.ok.Name = "ok";
			this.ok.TabIndex = 6;
			this.ok.Text = "OK";
			// 
			...
			this.cancel.Location = new System.Drawing.Point(96, 216);
			...
			// user
			// 
			this.user.Location = new System.Drawing.Point(24, 144);
			this.user.Name = "user";
			...
			// password
			// 
			this.password.Location = new System.Drawing.Point(24, 184);
		...
		private void config_Load(object sender, System.EventArgs e)
		{
				...
				try
				{
					...
					user.Text = keys[3].Trim();
					password.Text = keys[4].Trim();
				}
				catch
				{
